import { CustomColumnExpressionsVisitor } from "../antrl4-lang-grammar/CustomColumnExpressionsVisitor";
import {
  RoutineSymbol,
  ScopedSymbol,
  SymbolTable,
...
// } from "../antrl4-lang-grammar/CustomColumnExpressionsParser";

export class SymbolTableVisitor
  extends AbstractParseTreeVisitor<SymbolTable>
  implements CustomColumnExpressionsVisitor<SymbolTable>
{
  constructor(
